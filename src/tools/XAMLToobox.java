...
public class XAMLToobox {
    ...
    public Element createGridLayout(int rows, int columns) {
        Element rootElement = createXAMLElement("GridConfFromFile");
        Element columnDefinitions = createXAMLElement("GridConfFromFile.ColumnDefinitions");
        for (int i = 0; i < columns; i++) {
            Element definition = createXAMLElement("ColumnDefinition");
            columnDefinitions.addContent(definition);
        }
        Element rowDefinitions = createXAMLElement("GridConfFromFile.RowDefinitions");
    ...
    public Element createScrollViewer() {
        ...
        scrollViewer.setAttribute("GridConfFromFile.Row", "1");
        scrollViewer.setAttribute("GridConfFromFile.Column", "0");
        return scrollViewer;
    ...
    public Element createScrollViewer(int row, int column) {
        ...
        scrollViewer.setAttribute("HorizontalScrollBarVisibility", "Disabled");
        scrollViewer.setAttribute("VerticalScrollBarVisibility", "Auto");
        scrollViewer.setAttribute("GridConfFromFile.Row", ""+row);
        scrollViewer.setAttribute("GridConfFromFile.Column", "" + column);
        return scrollViewer;
